    ...
    <div class="register-photo">
        <div class="form-container">
            ...
            <form method="post" action="daftar.php">
                ...
                <div class="form-group"><button class="btn btn-primary btn-block" type="submit">Sign Up</button></div><a href="login.php" class="punyaakun">You already have an account? Login here.</a></form>
        </div>
    </div>
